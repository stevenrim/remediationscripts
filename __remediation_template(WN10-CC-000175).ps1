<#
.SYNOPSIS
I disabled the Inventory Collector by setting the DisableInventory registry value to 1. This prevents Windows from collecting and sending application inventory data, enhancing privacy and security.
