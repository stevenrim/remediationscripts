<#
.SYNOPSIS
This PowerShell script enforces that only the built-in Administrators group has the "Restore files and directories" (SeRestorePrivilege) user right by updating the local security policy.
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\__remediation_template(WN10-UR-000160).ps1 
#>
