<#
.SYNOPSIS
This PowerShell script updates the local security policy to ensure only the built-in Administrators group has the "Profile single process" (SeProfileSingleProcessPrivilege) user right, preventing unauthorized process performance monitoring.
...
.USAGE
    ...
    Example syntax:
    PS C:\> .\__remediation_template(WN10-UR-000150).ps1 
#>
